            ...
            <div class="header-navigation-slide__menu" id="slideMenu">
                ...
                <div class="header-navigation-slide__menu-content">
                    ...
                    <div class="header-navigation-slide__menu-content-body">
                        @if(Auth::guest())
                            <a class="header-navigation-slide__menu-content-body-link" href="/login"><i class="header-navigation-slide__menu-content-body-link-icon fa-solid fa-arrow-right-to-bracket"></i><p class="header-navigation-slide__menu-content-body-link-text">Login</p></a>
                            <a class="header-navigation-slide__menu-content-body-link" href="/register"><i class="header-navigation-slide__menu-content-body-link-icon fa-solid fa-user-plus"></i><p class="header-navigation-slide__menu-content-body-link-text">Register</p></a>
                        @else
                            <a class="header-navigation-slide__menu-content-body-link" href="/profile/{{ Auth::id() }}"><i class="header-navigation-slide__menu-content-body-link-icon fa-solid fa-user"></i><p class="header-navigation-slide__menu-content-body-link-text">Profile</p></a>
                            ...
                            <a class="header-navigation-slide__menu-content-body-link" href="/galleries"><i class="header-navigation-slide__menu-content-body-link-icon fa-solid fa-arrow-right-from-bracket"></i><p class="header-navigation-slide__menu-content-body-link-text">Logout</p></a>
                        @endif
