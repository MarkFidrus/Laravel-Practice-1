...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('/profile/{id}', '\App\Http\Controllers\PhotoController@show')
        ->name('profile')
        ->middleware('auth');
    ...
    Route::resource('apps', '\App\Http\Controllers\OtherAppController');
    Route::get('/apps', '\App\Http\Controllers\OtherAppController@index')
        ->name('apps')
        ->middleware('auth');
    ...
    Route::get('/messages', '\App\Http\Controllers\PhotoController@show')
        ->name('messages');
    Route::get('/messages/show/{id}', '\App\Http\Controllers\PhotoController@show')
        ->name('show_messages');
